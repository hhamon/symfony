...
class TranslatorTest extends TestCase
{
    ...
    public function getCssToXPathTestData()
    {
        return array(
            ...
            array('e:nth-child(1)', "*/*[local-name() = 'e' and (position() = 1)]"),
            array('e:nth-last-child(1)', "*/*[local-name() = 'e' and (position() = last() - 0)]"),
            array('e:nth-last-child(2n+2)', "*/*[local-name() = 'e' and (last() - position() - 1 >= 0 and (last() - position() - 1) mod 2 = 0)]"),
            ...
            array('e:first-child', "*/*[local-name() = 'e' and (position() = 1)]"),
            array('e:last-child', "*/*[local-name() = 'e' and (position() = last())]"),
            array('e:first-of-type', '*/e[position() = 1]'),
            array('e:last-of-type', '*/e[position() = last()]'),
            array('e:only-child', "*/*[local-name() = 'e' and (last() = 1)]"),
            ...
            array('e > f', 'e/f'),
            array('e + f', "e/following-sibling::*[local-name() = 'f' and (position() = 1)]"),
