    ...
    private function addFormSection(ArrayNodeDefinition $rootNode)
    {
        $rootNode
            ->validate()
                ...
                ->then(function ($v) {
                    trigger_error('The twig.form.resources configuration key is deprecated since version 2.6 and will be removed in 3.0. Use twig.form_themes key instead.', E_USER_DEPRECATED);
